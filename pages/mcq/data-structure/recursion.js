...
function QuizApp() {
    const quizData = [
        {
            question: "Recursion is a method in which the solution of problem depend on ______",
            options: [
                "Smaller instance of the same problem",
                "Larger instance of different problem",
                "Larger instance of same problem",
                "Smaller instance of different problems",
            ],
            answer: "Smaller instance of same problem",
        },
        {
            question: "Which of the following problem can be solved using recursion ?",
            options: [
