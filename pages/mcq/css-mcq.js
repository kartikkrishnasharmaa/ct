...
const cssmcq = () => {
    return (
        <McqLayout>
            <Head>
                <title>CSS Multiple Choice Question | Coding Tutorials</title>
            ...
            <section id="content-wrapper">
                <div>
                    <div className="divide-y divide-gray-300/50">
                        <h1 className="title-font sm:text-4xl text-center text-3xl mb-2 font-medium text-blue-700">CSS Multiple Choice Question</h1>
