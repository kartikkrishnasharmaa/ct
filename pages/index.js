...
import Mcq from "@layouts/components/Mcq";
...
import Quiz from "@layouts/components/Quiz";
        ...
        <div className="container">
          <div className="row items-start">
            <div className="mb-12 lg:mb-0 lg:col-8">
              ...
              {/* Promotion */ }
              { promotion.enable && (
                <Link href={ promotion.link } className="section pt-0 mb-3">
                  <ImageFallback
                    className=""
                    height="115"
                    width="800"
              ...
              {/* Recent Posts */ }
              { recent_posts.enable && (
                <div className="section pt-0 mt-8">
