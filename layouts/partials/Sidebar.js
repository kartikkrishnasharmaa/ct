...
const Sidebar = ( { posts, categories, className } ) => {
  ...
  return (
    <aside className={ `${className} px-0 lg:px-6 lg:col-4` }>
      ...
      <div className="mt-6 rounded border border-border p-6 dark:border-darkmode-border">
        <h4 className="section-title mb-12 text-center">Trending Posts</h4>
        <div
          className={ `flex items-center mb-6 border-b border-border pb-6 dark:border-darkmode-border"` }>
          <h5 className="h5 mb-2">
            <Link
              href="/posts/special-principle-that-will-supercharge-your-software-engineering-career"
              className="block hover:text-primary"
            >
              Principle that will supercharge your software engineering career
            </Link>
          </h5>
        </div>
        <div
          ...
          <h5 className="h5 mb-2">
            <Link
              href="/posts/how-to-maintain-mental-health-as-programmer"
              className="block hover:text-primary"
            >
              Maintain mental health as a programmer
            </Link>
          </h5>
        </div>
      </div>
